...
//        testRandom();
    ...
    private static void testString() {
        String str1 = "Java";
        String str2 = "Java";
        String str3 = new String("Java"); // устаревший подход
    ...
    public static void mainTestOverload() {
        testOverload(3, 4);
    ...
    private static void testOverload(double a, double b) {
        double multiple = a * b;
        System.out.printf("Произведение %.1f и %.1f равно: %.1f (double * double)%n", a, b, multiple);
    }
